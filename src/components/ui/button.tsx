  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Audio platform specific variants
        hero: "bg-gradient-primary text-foreground hover:scale-[1.05] active:scale-[0.95] shadow-lg hover:shadow-xl glow-primary",
        glass: "glass-card border-glass-border text-foreground hover:bg-glass-background/80 backdrop-blur-sm",
        player: "bg-player-background text-player-controls hover:bg-player-controls/10 border border-player-controls/20",
